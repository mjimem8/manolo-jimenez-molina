           ...
           <div class="fh5co-loader"></div>
            ...
            <div id="page">	
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-1.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-2.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Brading</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-3.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Illustration</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-4.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Design</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-5.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Website</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-6.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Illustration</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-7.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Brading</span>
                        </div>
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
                      <a href="#" class="work" style={{backgroud: "url(../images/portfolio-8.jpg);"}}>
                        <div class="desc">
                          <h3>Project Name</h3>
                          <span>Illustration</span>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="fh5co-blog animate-box">
                        <a href="#" class="blog-bg" style={{backgroud: "url(../images/portfolio-1.jpg);"}}></a>
                        <div class="blog-text">
                    ...
                    <div class="col-md-4">
                      <div class="fh5co-blog animate-box">
                        <a href="#" class="blog-bg" style={{backgroud: "url(../images/portfolio-2.jpg);"}}></a>
                        <div class="blog-text">
                          <span class="posted_on">Mar. 15th 2016</span>
                    ...
                    <div class="col-md-4">
                      <div class="fh5co-blog animate-box">
                        <a href="#" class="blog-bg" style={{backgroud: "url(../images/portfolio-3.jpg);"}}></a>
                        <div class="blog-text">
                          <span class="posted_on">Mar. 15th 2016</span>
              ...
              <div id="fh5co-consult">
                <div class="video fh5co-video" style={{backgroud: "url(../images/cover_bg_1.jpg);"}}>
                  <div class="overlay"></div>
                </div>
